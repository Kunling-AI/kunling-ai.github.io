...
export const leader = {
  ...
  affiliation: 'Ocean University of China · Key Lab of Submarine Geosciences and Prospecting Techniques, MOE',
...
export const team: Member[] = [
  ...
  },
  {
    ...
    currentFocus: 'Building TectonOS as an AI-native research environment for scientists to formulate questions, configure and run simulations, analyze results, generate figures, and produce reproducible research outputs with AI support.',
    links: [
